 ...
 * @author DongyangHu
 */
public class ExpireFoodTimer implements ActionListener {

    private final Timer foodTimer;
    private final SnakePanel snakePanel;

    public ExpireFoodTimer(SnakePanel snakePanel) {
        this.foodTimer = new Timer(GameConfig.EXPIRE_FOOD_TIMER_UNIT, this);
